...
def eda_q3(data_path, output_folder):
    ...
    cleaned_data_path = os.path.join(output_folder, "cleaned_data.xlsx")
...
if __name__ == "__main__":
    # Argument parsing to fit the pipeline flow
    parser = argparse.ArgumentParser(description="Perform EDA using the q3 approach.")
    parser.add_argument('--data', type=str, help="Path to the dataset.")
    parser.add_argument('--output', type=str, help="Folder to save the EDA outputs.")
    
    args = parser.parse_args()

    # Run EDA and save results to the specified output folder
    eda_q3(args.data, args.output)
